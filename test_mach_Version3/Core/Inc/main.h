...
#define S5_Pin        GPIO_PIN_4   /* PA4 — dự phòng, telemetry only */
#define S5_GPIO_Port  GPIOA
#define S6_Pin        GPIO_PIN_5   /* PA5 — dự phòng, telemetry only */
...
#define N1_Pin        GPIO_PIN_12   /* Audio B4 */
#define N1_GPIO_Port  GPIOB
#define N2_Pin        GPIO_PIN_13   /* Audio B3 */
#define N2_GPIO_Port  GPIOB
#define N3_Pin        GPIO_PIN_14   /* Audio B2 */
#define N3_GPIO_Port  GPIOB
#define N4_Pin        GPIO_PIN_15   /* Audio B1 */
#define N4_GPIO_Port  GPIOB

/* ── Nút / bumper PB4-PB9 ── */
#define Button_EMER_Pin       GPIO_PIN_9
#define Button_EMER_GPIO_Port GPIOB
#define Button_STOP_Pin       GPIO_PIN_8
...
#define Bumper_S1_Pin         GPIO_PIN_5
#define Bumper_S1_GPIO_Port   GPIOB
#define Bumper_S2_Pin         GPIO_PIN_4
